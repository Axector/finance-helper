...
import { BudgetPlan, CATEGORY_LABELS } from '@/types';
import {
    getBudgetPlans,
    getTransactions,
    addBudgetPlan,
...
export default function BudgetPage() {
    ...
    const handleAdd = (plan: BudgetPlan) => {
    ...
    return (
        <>
                        ...
                        >
                            ...
                            <div className="budget-card-header">
                                <div>
                                    ...
                                    <div className="budget-category">{CATEGORY_LABELS[item.plan.category]}</div>
                                </div>
            ...
            {/* Modal */}
            {showForm && (
                <BudgetForm onSubmit={handleAdd} onClose={() => setShowForm(false)} />
            )}
        </>
    );
}
